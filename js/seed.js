...
const Bank = (() => {
  ...
  const RETIRED_V = 5;   // v5: v1.4.16 — OCR variant-dupes pruned (kam repeat)
  async function pruneRetired() {
    try {
      ...
      const hs = new Set([].concat(ret.raga || [], ret.foreign || [], ret.physics || [], ret.mathematics || [], ret.v4 || [], ret.v5 || []));
      const doomed = [];
